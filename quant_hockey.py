# -*- coding: utf-8 -*-
"""
Created on Wed Feb 17 13:28:35 2021
...
for i in range(50):
    ...
    print("Weight: " + weight.replace(" ", "") + "\n")
    
    

#Progress: Able to access 50 item pages and return 6 attributes from each.
#TODO: Access second page of table to return item pages 51-100
#TODO: Insert data into list of dictionaries
#Index Page: NHL All Time Points Leaders
#Item pages: Hyperlinks to the first 100 players
#Attributes from Item Pages: Name, Birthday, Birthplace, Position, Height, Weight (many more)
